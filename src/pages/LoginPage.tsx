    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-primary rounded-2xl flex items-center justify-center mx-auto mb-4 float-animation">
        ...
        <div className="glass-card rounded-2xl p-8 animate-scale-in">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 glass-input border-none h-12"
                  required
                />
                <Button
                  type="button"
            ...
            <Button type="submit" className="w-full h-12 shadow-button">
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <Button variant="outline" className="btn-glass h-12">
